...
public class FindAllLinksandFrames {
	...
	public void LinksonPage()
	{
       ...
       List<WebElement> allElements=driver.findElements(By.xpath("//*[@href or @src or @onclick='http://']"));
    	     ...
    	     for (WebElement pagelink : num)
    	          {
    	           ...
    	           String clickonurl = pagelink.getText(); 
    	           String link = pagelink.getAttribute("href");
    	           String clickonlink = pagelink.getAttribute("onclick");
    	           System.out.println(linktext+" ->");
    	           System.out.println(link);
    	           System.out.println(clickonlink);
    	         }
    	    	}
    	   		catch (Exception e){
 ...
 * These values cause unexpected behavior when copying/dragging links, opening links in a new tabs/windows, book marking, and when JavaScript is still downloading, 
 * errors out, or is disabled. This also conveys incorrect semantics to associative technologies (e.g., screen readers). In these cases, it is recommended to use 
